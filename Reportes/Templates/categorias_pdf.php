...
<body>
    ...
    <div class="info">
        ...
        <p><strong>Total de registros:</strong> <?php echo count($categorias); ?></p>
        ...
        <tbody>
            <?php foreach ($categorias as $categoria): ?>
                <tr>
                    ...
                    <td><?php echo strtoupper($categoria['nombre']); ?></td>
                    <td><?php echo strtoupper($categoria['descrip'] ?? ''); ?></td>
                    <td class="<?php echo $categoria['estado'] == 'activo' ? 'estado-activo' : 'estado-inactivo'; ?>">
                        <?php echo strtoupper($categoria['estado']); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
