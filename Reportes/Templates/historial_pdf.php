...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .accion-registrar { color: #16a64d; font-weight: bold; }
        .accion-modificar { color: #155DFC; font-weight: bold; }
        .accion-desactivar { color: #e53935; font-weight: bold; }
        .accion-activar { color: #16a64d; font-weight: bold; }
