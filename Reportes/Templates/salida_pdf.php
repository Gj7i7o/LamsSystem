...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        th { background-color: #314158; color: #fff; padding: 10px 5px; text-align: left; font-size: 10px; }
        td { border: 1px solid #ddd; padding: 8px 5px; font-size: 10px; }
        tr:nth-child(even) { background-color: #f9f9f9; }
        .text-right { text-align: right; }
        .text-center { text-align: center; }
        .badge { padding: 2px 6px; border-radius: 3px; font-size: 9px; font-weight: bold; }
        .badge-venta { background-color: #d4edda; color: #155724; }
        .badge-uso_interno { background-color: #cce5ff; color: #004085; }
        .badge-danado { background-color: #f8d7da; color: #721c24; }
        .badge-devolucion { background-color: #fff3cd; color: #856404; }
